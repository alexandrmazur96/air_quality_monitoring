...
use Mazur\Application\Telegram\StartCommand;
    ...
    */
    'bots' => [
        'air-quality-ua' => [
            ...
            'webhook_url' => env('TELEGRAM_WEBHOOK_URL', rtrim(config('app.url'), '/') . '/api/telegram/webhook'),
            'webhook_auth_token' => env('TELEGRAM_WEBHOOK_AUTH_TOKEN', ''),
            /*
